...
;(function ($, window) {
  ...
  function _onImageLoad(e) {
    ...
    if ($window.width() > data.naturalWidth) {
      var rate = $window.width() / data.naturalWidth;
      data.naturalWidth = $window.width();
      data.naturalHeight = Math.floor(data.naturalHeight * rate);
    }

    if ($window.height() > data.naturalHeight) {
      var rate = $window.height() / data.naturalHeight;
      data.naturalHeight = $window.height();
      data.naturalWidth = Math.floor(data.naturalWidth * rate);
    }
    ...
    data.targetImageHeight = data.minHeight = data.maxHeight = data.naturalHeight * options.maxZoom;
    data.targetImageWidth  = data.minWidth  = data.maxWidth  = data.naturalWidth * options.maxZoom;
